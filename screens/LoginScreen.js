    ...
    const handleSubmit = async ()=>{
        if(email && password){
            try{
                ...
                let tituloMensaje, cuerpoMensaje="";
                console.log(err.code);
                if(err.code === 'auth/user-not-found'){
                    tituloMensaje="Correo incorrecto";
                    cuerpoMensaje="El correo no esta viculado a ninguna cuenta";
                }else if(err.code === 'auth/wrong-password'){
                    tituloMensaje="Contraseña incorrecta";
                    cuerpoMensaje="La contraseña no es viculada a esta cuenta";
                } else {
                    tituloMensaje='Error desconocido';
                    cuerpoMensaje=err.code;
            ...
            <View className="flex-1 bg-white px-8 pt-8"
                ...
                <View className="flex-row justify-center mt-7">
                    ...
                    <TouchableOpacity onPress={() => {navigation.navigate('SignUp')}}>
                        <Text className="text-yellow-400 font-semibold"> Sign In
                        </Text>
                    </TouchableOpacity>
                </View>    
            </View>
